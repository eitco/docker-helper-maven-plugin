...
public class DockerExecMojo extends AbstractDockerMojo {
    ...
    private String createExec(CloseableHttpClient httpClient, URI dockerUri) throws IOException, MojoExecutionException {
    ...
    private void startExec(CloseableHttpClient httpClient, URI dockerUri, String execId) throws IOException, MojoExecutionException {
        ObjectNode request = OBJECT_MAPPER.createObjectNode();
    ...
    private void waitForSuccessfulExit(CloseableHttpClient httpClient, URI dockerUri, String execId) throws IOException, MojoExecutionException {
        while (true) {
    ...
    private static void ensureSuccess(CloseableHttpResponse response, String operation) throws IOException, MojoExecutionException {
